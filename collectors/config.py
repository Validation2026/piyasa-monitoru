...
STOCKS = {
    ...
    "symbols": {
        ...
        # ── BIST Tam Liste (Ek) ─────────────────────
        "A1CAP.IS": {"name": "A1CAP (BIST)", "unit": "TRY"},
        "A1YEN.IS": {"name": "A1YEN (BIST)", "unit": "TRY"},
        "ACSEL.IS": {"name": "ACSEL (BIST)", "unit": "TRY"},
        "ADEL.IS": {"name": "ADEL (BIST)", "unit": "TRY"},
        "ADESE.IS": {"name": "ADESE (BIST)", "unit": "TRY"},
        "ADGYO.IS": {"name": "ADGYO (BIST)", "unit": "TRY"},
        "AFYON.IS": {"name": "AFYON (BIST)", "unit": "TRY"},
        "AGROT.IS": {"name": "AGROT (BIST)", "unit": "TRY"},
        "AGYO.IS": {"name": "AGYO (BIST)", "unit": "TRY"},
        "AHGAZ.IS": {"name": "AHGAZ (BIST)", "unit": "TRY"},
        "AHSGY.IS": {"name": "AHSGY (BIST)", "unit": "TRY"},
        "AKENR.IS": {"name": "AKENR (BIST)", "unit": "TRY"},
        "AKSGY.IS": {"name": "AKSGY (BIST)", "unit": "TRY"},
        ...
        "ALGYO.IS": {"name": "ALGYO (BIST)", "unit": "TRY"},
        ...
        "BINHO.IS": {"name": "BINHO (BIST)", "unit": "TRY"},
        ...
        "BRSAN.IS": {"name": "BRSAN (BIST)", "unit": "TRY"},
        "BRYAT.IS": {"name": "BRYAT (BIST)", "unit": "TRY"},
        "BSOKE.IS": {"name": "BSOKE (BIST)", "unit": "TRY"},
        "BTCIM.IS": {"name": "BTCIM (BIST)", "unit": "TRY"},
        "BUCIM.IS": {"name": "BUCIM (BIST)", "unit": "TRY"},
        "BURCE.IS": {"name": "BURCE (BIST)", "unit": "TRY"},
        "BURVA.IS": {"name": "BURVA (BIST)", "unit": "TRY"},
        "BVSAN.IS": {"name": "BVSAN (BIST)", "unit": "TRY"},
        "BYDNR.IS": {"name": "BYDNR (BIST)", "unit": "TRY"},
        "CANTE.IS": {"name": "CANTE (BIST)", "unit": "TRY"},
        "CASA.IS": {"name": "CASA (BIST)", "unit": "TRY"},
        "CELHA.IS": {"name": "CELHA (BIST)", "unit": "TRY"},
        "CEMAS.IS": {"name": "CEMAS (BIST)", "unit": "TRY"},
        ...
        "CUSAN.IS": {"name": "CUSAN (BIST)", "unit": "TRY"},
        "CVKMD.IS": {"name": "CVKMD (BIST)", "unit": "TRY"},
        ...
        "DGGYO.IS": {"name": "DGGYO (BIST)", "unit": "TRY"},
        ...
        "DOKTA.IS": {"name": "DOKTA (BIST)", "unit": "TRY"},
        "DURDO.IS": {"name": "DURDO (BIST)", "unit": "TRY"},
        "DYOBY.IS": {"name": "DYOBY (BIST)", "unit": "TRY"},
        "EBEBK.IS": {"name": "EBEBK (BIST)", "unit": "TRY"},
        ...
        "EKSUN.IS": {"name": "EKSUN (BIST)", "unit": "TRY"},
        "ELITE.IS": {"name": "ELITE (BIST)", "unit": "TRY"},
        "EMKEL.IS": {"name": "EMKEL (BIST)", "unit": "TRY"},
        "EMNIS.IS": {"name": "EMNIS (BIST)", "unit": "TRY"},
        "EPLAS.IS": {"name": "EPLAS (BIST)", "unit": "TRY"},
        "ERBOS.IS": {"name": "ERBOS (BIST)", "unit": "TRY"},
        "ERCB.IS": {"name": "ERCB (BIST)", "unit": "TRY"},
        "ERSU.IS": {"name": "ERSU (BIST)", "unit": "TRY"},
        "ESCAR.IS": {"name": "ESCAR (BIST)", "unit": "TRY"},
        "ESCOM.IS": {"name": "ESCOM (BIST)", "unit": "TRY"},
        "ESEN.IS": {"name": "ESEN (BIST)", "unit": "TRY"},
        ...
        "EUREN.IS": {"name": "EUREN (BIST)", "unit": "TRY"},
        "EYGYO.IS": {"name": "EYGYO (BIST)", "unit": "TRY"},
        ...
        "IMASM.IS": {"name": "IMASM (BIST)", "unit": "TRY"},
        "INFO.IS": {"name": "INFO (BIST)", "unit": "TRY"},
        "INGRM.IS": {"name": "INGRM (BIST)", "unit": "TRY"},
        "INTEM.IS": {"name": "INTEM (BIST)", "unit": "TRY"},
        "INVEO.IS": {"name": "INVEO (BIST)", "unit": "TRY"},
        "INVES.IS": {"name": "INVES (BIST)", "unit": "TRY"},
        ...
        "ISYAT.IS": {"name": "ISYAT (BIST)", "unit": "TRY"},
        "ITTFH.IS": {"name": "ITTFH (BIST)", "unit": "TRY"},
        "IZENR.IS": {"name": "IZENR (BIST)", "unit": "TRY"},
        ...
        "KAREL.IS": {"name": "KAREL (BIST)", "unit": "TRY"},
        "KARSN.IS": {"name": "KARSN (BIST)", "unit": "TRY"},
        ...
        "KFEIN.IS": {"name": "KFEIN (BIST)", "unit": "TRY"},
        "KGYO.IS": {"name": "KGYO (BIST)", "unit": "TRY"},
        "KLKIM.IS": {"name": "KLKIM (BIST)", "unit": "TRY"},
        "KLNMA.IS": {"name": "KLNMA (BIST)", "unit": "TRY"},
        "KLRHO.IS": {"name": "KLRHO (BIST)", "unit": "TRY"},
        "KLSER.IS": {"name": "KLSER (BIST)", "unit": "TRY"},
        "KLSYN.IS": {"name": "KLSYN (BIST)", "unit": "TRY"},
        "KMPUR.IS": {"name": "KMPUR (BIST)", "unit": "TRY"},
        "KONKA.IS": {"name": "KONKA (BIST)", "unit": "TRY"},
        "KRPLS.IS": {"name": "KRPLS (BIST)", "unit": "TRY"},
        "KSTUR.IS": {"name": "KSTUR (BIST)", "unit": "TRY"},
        "KTLEV.IS": {"name": "KTLEV (BIST)", "unit": "TRY"},
        "KTSKR.IS": {"name": "KTSKR (BIST)", "unit": "TRY"},
        "KUTPO.IS": {"name": "KUTPO (BIST)", "unit": "TRY"},
        "KUYAS.IS": {"name": "KUYAS (BIST)", "unit": "TRY"},
        "LIDER.IS": {"name": "LIDER (BIST)", "unit": "TRY"},
        "LIDFA.IS": {"name": "LIDFA (BIST)", "unit": "TRY"},
        "LKMNH.IS": {"name": "LKMNH (BIST)", "unit": "TRY"},
        "LUKSK.IS": {"name": "LUKSK (BIST)", "unit": "TRY"},
        "MAALT.IS": {"name": "MAALT (BIST)", "unit": "TRY"},
        "MACKO.IS": {"name": "MACKO (BIST)", "unit": "TRY"},
        ...
        "MERCN.IS": {"name": "MERCN (BIST)", "unit": "TRY"},
        "METRO.IS": {"name": "METRO (BIST)", "unit": "TRY"},
        "MHRGY.IS": {"name": "MHRGY (BIST)", "unit": "TRY"},
        "MNDRS.IS": {"name": "MNDRS (BIST)", "unit": "TRY"},
        "MNDTR.IS": {"name": "MNDTR (BIST)", "unit": "TRY"},
        "MOBTL.IS": {"name": "MOBTL (BIST)", "unit": "TRY"},
        "MTRKS.IS": {"name": "MTRKS (BIST)", "unit": "TRY"},
        "NIBAS.IS": {"name": "NIBAS (BIST)", "unit": "TRY"},
        "NTGAZ.IS": {"name": "NTGAZ (BIST)", "unit": "TRY"},
        "ODINE.IS": {"name": "ODINE (BIST)", "unit": "TRY"},
        "ONRYT.IS": {"name": "ONRYT (BIST)", "unit": "TRY"},
        "ORCAY.IS": {"name": "ORCAY (BIST)", "unit": "TRY"},
        "ORMA.IS": {"name": "ORMA (BIST)", "unit": "TRY"},
        "OSTIM.IS": {"name": "OSTIM (BIST)", "unit": "TRY"},
        "OYLUM.IS": {"name": "OYLUM (BIST)", "unit": "TRY"},
        "OZRDN.IS": {"name": "OZRDN (BIST)", "unit": "TRY"},
        "PAGYO.IS": {"name": "PAGYO (BIST)", "unit": "TRY"},
        "PARSN.IS": {"name": "PARSN (BIST)", "unit": "TRY"},
        "PEKGY.IS": {"name": "PEKGY (BIST)", "unit": "TRY"},
        "PENGD.IS": {"name": "PENGD (BIST)", "unit": "TRY"},
        "PINSU.IS": {"name": "PINSU (BIST)", "unit": "TRY"},
        "PKART.IS": {"name": "PKART (BIST)", "unit": "TRY"},
        "PLTUR.IS": {"name": "PLTUR (BIST)", "unit": "TRY"},
        "PNLSN.IS": {"name": "PNLSN (BIST)", "unit": "TRY"},
        "POLHO.IS": {"name": "POLHO (BIST)", "unit": "TRY"},
        "PRDGS.IS": {"name": "PRDGS (BIST)", "unit": "TRY"},
        "PSDTC.IS": {"name": "PSDTC (BIST)", "unit": "TRY"},
        "QUAGR.IS": {"name": "QUAGR (BIST)", "unit": "TRY"},
        "RALYH.IS": {"name": "RALYH (BIST)", "unit": "TRY"},
        "RAYSG.IS": {"name": "RAYSG (BIST)", "unit": "TRY"},
        "RHEAG.IS": {"name": "RHEAG (BIST)", "unit": "TRY"},
        "RODRG.IS": {"name": "RODRG (BIST)", "unit": "TRY"},
        "RTALB.IS": {"name": "RTALB (BIST)", "unit": "TRY"},
        "SAFKR.IS": {"name": "SAFKR (BIST)", "unit": "TRY"},
        "SAMAT.IS": {"name": "SAMAT (BIST)", "unit": "TRY"},
        "SANFM.IS": {"name": "SANFM (BIST)", "unit": "TRY"},
        "SANKO.IS": {"name": "SANKO (BIST)", "unit": "TRY"},
        "SANEL.IS": {"name": "SANEL (BIST)", "unit": "TRY"},
        "SARKY.IS": {"name": "SARKY (BIST)", "unit": "TRY"},
        "SAYAS.IS": {"name": "SAYAS (BIST)", "unit": "TRY"},
        "SEGMN.IS": {"name": "SEGMN (BIST)", "unit": "TRY"},
        "SEKFK.IS": {"name": "SEKFK (BIST)", "unit": "TRY"},
        "SEKUR.IS": {"name": "SEKUR (BIST)", "unit": "TRY"},
        ...
        "SNICA.IS": {"name": "SNICA (BIST)", "unit": "TRY"},
        ...
        "SURGY.IS": {"name": "SURGY (BIST)", "unit": "TRY"},
        "TATEN.IS": {"name": "TATEN (BIST)", "unit": "TRY"},
        "TEKTU.IS": {"name": "TEKTU (BIST)", "unit": "TRY"},
        "TERA.IS": {"name": "TERA (BIST)", "unit": "TRY"},
        "TGSAS.IS": {"name": "TGSAS (BIST)", "unit": "TRY"},
        "TIRE.IS": {"name": "TIRE (BIST)", "unit": "TRY"},
        "TMPOL.IS": {"name": "TMPOL (BIST)", "unit": "TRY"},
        "TNZTP.IS": {"name": "TNZTP (BIST)", "unit": "TRY"},
        "TRILC.IS": {"name": "TRILC (BIST)", "unit": "TRY"},
        "TSPOR.IS": {"name": "TSPOR (BIST)", "unit": "TRY"},
        "TUCLK.IS": {"name": "TUCLK (BIST)", "unit": "TRY"},
        "TUKAS.IS": {"name": "TUKAS (BIST)", "unit": "TRY"},
        "TUREX.IS": {"name": "TUREX (BIST)", "unit": "TRY"},
        "UFUK.IS": {"name": "UFUK (BIST)", "unit": "TRY"},
        "ULAS.IS": {"name": "ULAS (BIST)", "unit": "TRY"},
        "ULUSE.IS": {"name": "ULUSE (BIST)", "unit": "TRY"},
        "USAK.IS": {"name": "USAK (BIST)", "unit": "TRY"},
        "VANGD.IS": {"name": "VANGD (BIST)", "unit": "TRY"},
        "VBTYZ.IS": {"name": "VBTYZ (BIST)", "unit": "TRY"},
        "VERTU.IS": {"name": "VERTU (BIST)", "unit": "TRY"},
        "VKFYO.IS": {"name": "VKFYO (BIST)", "unit": "TRY"},
        "YAPRK.IS": {"name": "YAPRK (BIST)", "unit": "TRY"},
        "YAYLA.IS": {"name": "YAYLA (BIST)", "unit": "TRY"},
        "YBTAS.IS": {"name": "YBTAS (BIST)", "unit": "TRY"},
        "YGGYO.IS": {"name": "YGGYO (BIST)", "unit": "TRY"},
        "YGYO.IS": {"name": "YGYO (BIST)", "unit": "TRY"},
        "YKSLN.IS": {"name": "YKSLN (BIST)", "unit": "TRY"},
        "YUNSA.IS": {"name": "YUNSA (BIST)", "unit": "TRY"},
        "YYLGD.IS": {"name": "YYLGD (BIST)", "unit": "TRY"},
        "ZEDUR.IS": {"name": "ZEDUR (BIST)", "unit": "TRY"},
        "ZRGYO.IS": {"name": "ZRGYO (BIST)", "unit": "TRY"},
